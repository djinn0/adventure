...
/* Add <script src="NavBar.js"></script> and <style> tag to <head>  */
...
function generateNavBar() {
    ...
    var e2 = '<li class="navigation-element"><a href="#">New Posts</a></li>';
    var edc1 = '<a href="#">Articles</a>'; 
    var edc2 = '<a href="#">Adventures</a>'; 
    var edc3 = '<a href="#">About</a>';
    var edm = '<div class="dropdown-content">' + edc1 + edc2 + edc3 + '</div>';
    var e3 = '<li class="navigation-element" id="dropdown"><a href="#">Menu&#9662;</a>' + edm + '</li>';
    var c1 = '<br id="b1"><br id="b2"><div class="converter-bar" id="cb"></div>' /* Adds a div below the nav bar. */
